...
namespace Genso
{
    ...
    inline bool CircleHit(sf::Vector2f pos1,float r1,
        sf::Vector2f pos2,float r2);

    inline bool CircleHit(sf::Vector2f pos1,sf::Vector2f last_pos1,float r1,
        sf::Vector2f pos2,sf::Vector2f last_pos2,float r2);

    inline bool AABBCircleHit(sf::Vector2f pos1,sf::Vector2f size1,
        sf::Vector2f pos2,float r);

    inline bool SegmentLaserHit(sf::Vector2f pos1,sf::Vector2f pos2,
